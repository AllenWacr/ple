    ...
    <OrganizationLayout title="Dashboard">
        ...
        <div class="container mx-auto pt-5">
            <div class="bg-white relative shadow rounded-lg overflow-x-auto p-5">
                <a-form :model="article" name="Teacher" layout="vertical" autocomplete="off" :rules="rules"
                    :validate-messages="validateMessages" @finish="onFinish">
                    <a-form-item :label="$t('article_category')" name="category_code">
                        <a-select v-model:value="article.category_code" :options="articleCategories" />
                    </a-form-item>
                    ...
                    <a-row>
                        <a-col>
                            <a-form-item :label="$t('published')" name="published">
                                <a-switch v-model:checked="article.published" :checkedValue="1" :unCheckedValue="0"
                                    @change="article.public = 0" />
                            </a-form-item>
                        </a-col>
                        <a-col class="pl-10" v-if="article.published">
                            <a-form-item :label="$t('public')" name="public">
                                <a-switch v-model:checked="article.public" :checkedValue="1" :unCheckedValue="0" />
                            </a-form-item>
                        </a-col>
                    </a-row>
        ...
        <a-drawer v-model:visible="isDrawerVisible" class="custom-class" title="Basic Drawer" placement="right"
            ...
            <div>
                <div v-if="selectedMedia">
                    <img v-if="selectedMedia.preview_url" :src="selectedMedia.preview_url" width="100" />
